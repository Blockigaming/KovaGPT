...
ARG VITE_KOVA_MAPS_PROVIDER_APPROVED=false
WORKDIR /app
...
RUN VITE_PAYMENTS_CLIENT_TOKEN="$VITE_PAYMENTS_CLIENT_TOKEN" VITE_KOVA_MAPS_PROVIDER_APPROVED="$VITE_KOVA_MAPS_PROVIDER_APPROVED" KOVA_BUILD_SHA="$KOVA_SOURCE_SHA" npm run build \
