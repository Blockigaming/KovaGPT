...
test("account cleanup removes only A plus unscoped private state", () => {
  const local = new MemoryStorage([
    ...
    ["kova.write.versions.v1:v2:user:A", '[{"title":"A version"}]'],
    ["kova.write.versions.v1:v2:user:B", '[{"title":"B version"}]'],
    ["kova-message-feedback:v2:user:A:message-1", "up"],
    ["kova-message-feedback:v2:user:B:message-1", "down"],
  ...
  for (const key of [
    ...
    "kova.write.versions.v1:v2:user:A",
    "kova-message-feedback:v2:user:A:message-1",
  ...
  for (const key of [
    ...
    "kova.write.versions.v1:v2:user:B",
    "kova-message-feedback:v2:user:B:message-1",
