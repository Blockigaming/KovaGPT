...
test("Kova eval default validates all 30 smoke cases and 12 categories", () => {
  ...
  for (const category of [
    "general_chat", "coding", "instruction_following", "reasoning_math", "tool_use",
    "deep_research", "safety_privacy", "factuality", "kova_specific",
    "agentic_execution", "long_context", "multi_turn",
  ]) {
