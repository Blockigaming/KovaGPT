...
test("Azure provider contract requires GPT-5.6 Sol and managed identity", () => {
  const provider =
    'type ProviderKind = "azure_openai" | "openai"; https://api.openai.com/v1 .openai.azure.com .services.ai.azure.com /openai/v1 IDENTITY_ENDPOINT IDENTITY_HEADER const AZURE_OPENAI_RESOURCE = "https://ai.azure.com" searchParams.set("resource", AZURE_OPENAI_RESOURCE) searchParams.set("api-version", "2019-08-01") redirect: "error" "/responses" responsesStreamToChatStream AZURE_OPENAI_DEPLOYMENT_DEEP';
  const catalog =
