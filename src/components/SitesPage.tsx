                ...
                <>
                  ...
                  <div className="space-y-3 border-t pt-5">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Input
                        className="max-w-sm"
                        aria-label="Work Site output ID"
                        placeholder="Work Site output ID"
                        value={workId}
                      ...
                      >
                        Import verified Work Site
                      </Button>
                    </div>
                    <p className="text-sm text-muted-foreground">
                      Import creates an unpublished version. Publishing still requires a separate
                      confirmation.
                    </p>
                  </div>
                  <div className="space-y-3 border-t pt-5">
