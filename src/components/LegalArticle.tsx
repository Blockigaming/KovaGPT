...
export function LegalArticle({ children }: { children: ReactNode }) {
  return (
    <main id="main-content" tabIndex={-1} className="min-w-0 flex-1 [overflow-wrap:anywhere]">
      <article
        className={[
          "mx-auto min-w-0 max-w-3xl px-6 py-16 text-foreground",
          // Headings
          ...
          // Body
          "[&_p]:my-5 [&_p]:leading-[1.8] [&_p]:text-[0.9375rem] [&_p]:text-foreground/85",
          // Lists
          ...
          // Links
          "[&_a]:underline [&_a]:underline-offset-2 [&_a]:text-foreground hover:[&_a]:text-foreground/70 [&_a:focus-visible]:outline-2 [&_a:focus-visible]:outline-ring [&_a:focus-visible]:outline-offset-2",
