            ...
            <div className="flex gap-3">
              ...
              <div className="min-w-0">
                ...
                <button
                  ...
                  onClick={askKova}
                  disabled={!isLoaded}
                  className="mt-3 disabled:cursor-not-allowed disabled:opacity-50 inline-flex items-center gap-1.5 rounded-lg bg-primary px-3 py-2 text-xs font-medium text-primary-foreground"
                >
