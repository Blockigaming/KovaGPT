  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "fixed z-50 flex flex-col gap-4 border border-border/80 bg-background/96 shadow-[var(--shadow-floating)] backdrop-blur-xl duration-[var(--motion-menu)]",
        ...
        "sm:inset-auto sm:left-[50%] sm:top-[50%] sm:bottom-auto sm:w-[min(92vw,720px)] sm:max-w-[92vw] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-[var(--kova-radius-panel)] sm:border-b sm:p-6 sm:pb-6 sm:max-h-[88dvh]",
