...
export function structuralReadiness(): ReadinessReport {
  const capabilities: Record<string, Capability> = {
    ...
    aiProvider: capability(any("OPENAI_API_KEY")),
    agentRunner: capability(present("SUPABASE_URL", "SUPABASE_SERVICE_ROLE_KEY", "OPENAI_API_KEY")),
    ...
    images: capability(any("OPENAI_API_KEY")),
