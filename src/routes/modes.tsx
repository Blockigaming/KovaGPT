  ...
  head: () => ({
    meta: [
      { title: "KovaGPT AI Modes" },
      {
        name: "description",
        content:
          "Learn what each KovaGPT mode is best for - Basic, Auto, Creative, Precise, Code, Study, Reasoning, Research, Writer Pro, and Tutor Pro.",
      },
...
const MODES: { name: string; copy: string; bestFor: string }[] = [
  {
    name: "Basic Mode",
    copy: "Simple everyday AI help for quick questions, writing, summaries, and general tasks.",
    bestFor: "Everyday questions",
  },
  {
    name: "Auto Mode",
    copy: "Automatically chooses the best style of response based on what you ask.",
    bestFor: "Choosing the right style automatically",
  },
  {
    name: "Creative Mode",
    copy: "Best for brainstorming, stories, ideas, names, captions, designs, and creative writing.",
    bestFor: "Ideas and brainstorming",
  },
  {
    name: "Precise Mode",
    copy: "Best for careful, direct answers when accuracy and clarity matter.",
    bestFor: "Clear and careful answers",
  },
  {
    name: "Code Mode",
    copy: "Helps write, debug, explain, and improve code.",
    bestFor: "Coding and debugging",
  },
  {
    name: "Study Mode",
    copy: "Explains topics step by step, helps with studying, and can create practice questions.",
    bestFor: "Learning and practice",
  },
  {
    name: "Reasoning Mode",
    copy: "Built for harder problems that need deeper thinking, planning, or logic.",
    bestFor: "Harder thinking tasks",
  },
  {
    name: "Research Mode",
    copy: "Helps organize information, compare sources, and create structured research summaries.",
    bestFor: "Structured research help",
  },
  {
    name: "Writer Pro",
    copy: "Helps improve essays, emails, scripts, posts, and professional writing.",
    bestFor: "Polished writing",
  },
  {
    name: "Tutor Pro",
    copy: "Gives more detailed explanations, guided learning, and personalized study help.",
    bestFor: "Guided learning",
  },
];
          ...
          {MODES.map((m) => (
            <div key={m.name} className="rounded-xl border border-border p-4 bg-card">
              ...
              <p className="text-xs text-muted-foreground mt-2">
                <span className="font-medium text-foreground">Best for:</span> {m.bestFor}
              </p>
            </div>
          ))}
        </div>
