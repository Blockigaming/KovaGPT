    ...
    <main className="mx-auto max-w-3xl px-6 py-16 text-foreground">
      ...
      <article className="prose prose-invert max-w-none">
        ...
        <p className="mt-6 text-lg leading-relaxed">
          ...
          guarantee that a number is current, a citation supports a claim, or a source is reliable.
          The safest workflow keeps the evidence visible and separates sourced facts from estimates
          and interpretation.
        </p>

        <h2 className="mt-10 text-2xl font-semibold">1. Start with a decision</h2>
        <p>
          Write the decision in one sentence, then define geography, customer, time period, and the
          confidence you need. For example:{" "}
        ...
        <p>
          ...
          on every prompt: search is conditional, users can explicitly disable it, and it requires a
          configured and available search provider. A failed or empty search should not be treated
          as proof that no evidence exists.
        </p>
        <p>
          Ask for the source title, publisher, publication date, and the exact claim each source is
          meant to support. Then open the links yourself. A well-formatted citation can still point
          to a weak, outdated, or misread page.
        </p>
        ...
        <p>
          ...
          independent source or reproduce the calculation. Record disagreements instead of averaging
          them away.
        </p>

        <h2 className="mt-10 text-2xl font-semibold">6. Label facts, inferences, and estimates</h2>
...
State when a source cannot be opened or when evidence is missing. Do not invent citations.`}
        ...
        <p>
          KovaGPT can make mistakes, including with retrieved material. Search and Deep Research are
