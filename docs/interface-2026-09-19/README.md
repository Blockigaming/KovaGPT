...
The working register contains **634 unique destinations/templates**, with 204 destinations from the 205 curated references, 4 additional documented Grok connector providers, 154 app screens/templates, 31 wider portal/content layouts, and 241 additional public-page candidates. The latter 241 remain candidates. Another 70 source manifest definitions require inspection before their Kova disposition is final. **634 is not the final verified count of eligible pages.** Content instances and language variants are tracked separately from visual templates.
...
2. Resolve the 241 candidates, 70 app definitions and three wider filter-review groups before freezing the page total. Preserve the existing 205 curated references and exclusion history.
