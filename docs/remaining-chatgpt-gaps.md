...
| Lockdown Mode                                                                 | Account policy persistence plus enforcement at every outbound tool, connector, fetch, and remote-file boundary. |
...
| Long-running background agent execution                     | A configured agent/task runner must expose durable execution, pause, resume, approvals, and truthful progress. |
