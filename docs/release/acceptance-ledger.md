...
| 05  | Deep Research                          | Excluded by owner            | Dedicated execution, navigation, progress, and report-management surfaces are removed; historical rows remain exportable and deletable.  | Ordinary web search remains supported; retired Deep Research identifiers are accepted only as migration input and omitted from normalized output.     |
