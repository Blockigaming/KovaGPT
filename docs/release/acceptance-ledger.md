...
| 05  | Retired Deep Research surface              | Excluded; retired          | Dedicated Deep Research is retired; ordinary cited web search remains available through the shared search provider.                       | No dedicated planner, persisted Deep Research run, or Deep Research composer tool is exposed.                                             |
