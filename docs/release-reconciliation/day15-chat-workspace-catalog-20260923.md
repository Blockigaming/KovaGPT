...
Three separate PostgreSQL `REPEATABLE READ, READ ONLY` transactions on
project `mfbycmbjygcfkrsuepxf` returned:

| Capture                                                | Observed state                                                                                                                                                      | Exact capture file SHA-256                                         |
| ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| Four table catalogs, 2026-09-23 21:28:43.102 UTC       | 98 migration versions; the four scoped tables have 13/7/14/9 columns, 10/5/12/8 constraints, 5/2/5/4 indexes, four policies each, 2/1/1/1 triggers, and RLS enabled | `25fa88c49788f4c6754c3aa2ef5054caf704f11b325eab1416200d1d4c88cc7d` |
| Selected routine families, 2026-09-23 21:32:51.515 UTC | 98 migration versions; 19 matching routines across the 22 selected name families, none marked SECURITY DEFINER and none effectively executable by `anon`            | `ebb64a328fc4a0ec0a758bbc63393cc091d9e656f7a3712fe466a60b36a203aa` |
| Four table data compatibility counts                   | All four table row totals were zero in a separate read-only count transaction; 24 named violation counts were zero in a later transaction                           | `b09c422b7d7ffa23a0a8dc89895495f32ae1bf2352b8a28b8c0f7360a60eee1d` |

The catalog outputs contain PostgreSQL metadata (column names and types,
