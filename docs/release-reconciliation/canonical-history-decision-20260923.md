...
writer review. The retained live catalog comparisons are partial evidence and
do not constitute 19 accepted proofs.
...
3. Review the **proposed per-source-version action** for all 111 absent source
   ...
   prior control rehearsal's 180 rows as a production target.
