...
// requires three history-only records before pushing the remaining 81 bodies.
...
if (projectRef === unreconciledProductionRef && !previewOnly) {
  console.error(
    "production_history_requires_approved_81_plus_3_plan: only exact --dry-run or --include-all --dry-run previews are permitted for this production project; no migration push was started.",
  );
  process.exit(2);
}
