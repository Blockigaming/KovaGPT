...
ALLOWED_FILE="$(mktemp "${TMPDIR:-/tmp}/kova-work-v2-max-allowed.XXXXXX")"
CHANGED_FILE="$(mktemp "${TMPDIR:-/tmp}/kova-work-v2-max-changed.XXXXXX")"
STAGED_FILE="$(mktemp "${TMPDIR:-/tmp}/kova-work-v2-max-staged.XXXXXX")"
