...
export const BUNDLE_BASELINE = Object.freeze({
  ...
  adjustment:
    "The 2026-09-13 build adds generated four-segment routing plus a dedicated Academy catalog route and emits a 183,053-byte gzip entry; the 183,500-byte ceiling retains less than 0.3% headroom.",
});

export const BUNDLE_BUDGETS = Object.freeze({
  initial: Object.freeze({ raw: 62_500, gzip: 20_000 }),
  main: Object.freeze({ raw: 625_000, gzip: 183_500 }),
